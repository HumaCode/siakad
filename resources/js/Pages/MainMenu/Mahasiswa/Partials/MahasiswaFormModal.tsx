        ...
        if (isOpen) {
            ...
            if (mahasiswa) {
                ...
                setData({
                    ...
                    // Detailed fields loaded from database with fallback values if null/empty
                    nik: mahasiswa.nik || '3273240212980003',
                    no_kk: mahasiswa.no_kk || '3273241010150002',
                    tempat_lahir: mahasiswa.tempat_lahir || 'Bandung',
                    tanggal_lahir: mahasiswa.tanggal_lahir || '2002-12-12',
                    jenis_kelamin: mahasiswa.jenis_kelamin || 'Laki-laki',
                    agama: mahasiswa.agama || 'Islam',
                    kewarganegaraan: mahasiswa.kewarganegaraan || 'WNI',
                    no_hp: mahasiswa.no_hp || '0812-3456-7890',
                    alamat: mahasiswa.alamat || 'Jl. Merdeka No. 45, Bandung',
                    semester_saat_ini: mahasiswa.semester_saat_ini ? String(mahasiswa.semester_saat_ini) : '1',
                    fakultas: mahasiswa.fakultas || 'Teknik & Teknologi',
                    jalur_masuk: mahasiswa.jalur_masuk || 'SNBT (SBMPTN)',
                    kelas: mahasiswa.kelas || defaultClass,
                    asal_sekolah: mahasiswa.asal_sekolah || 'SMAN 1 Bandung',
                    tahun_lulus_sma: mahasiswa.tahun_lulus_sma ? String(mahasiswa.tahun_lulus_sma) : '2020',
                    status_awal: mahasiswa.status_awal || 'Aktif',
                    ayah_nama: mahasiswa.ayah_nama || 'Asep Sunandar',
                    ayah_pekerjaan: mahasiswa.ayah_pekerjaan || 'Wiraswasta',
                    ayah_penghasilan: mahasiswa.ayah_penghasilan || 'Rp 2–5 Jt',
                    ibu_nama: mahasiswa.ibu_nama || 'Siti Aminah',
                    ibu_pekerjaan: mahasiswa.ibu_pekerjaan || 'Ibu Rumah Tangga',
                    ibu_no_hp: mahasiswa.ibu_no_hp || '0812-9876-5432',
                    ortu_alamat: mahasiswa.ortu_alamat || '',
                    email_akademik: mahasiswa.user?.email || '',
                    email_pribadi: mahasiswa.email_pribadi || 'mhs.pribadi@gmail.com',
                    password_awal: '',
                    konfirmasi_password: '',
                    kirim_notif: true,
                });
